...
BOOL WINAPI DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpvReserved) {
  TRACE("(0x%p, %lu, %p)\n", hinstDLL, (unsigned long)fdwReason, lpvReserved);
 ...
 *
 */
char *__stdcall FREETRACKCLIENT_FTProvider(void) { return "Freetrack"; }
/******************************************************************
...
bool __stdcall FREETRACKCLIENT_FTGetData(FreeTrackData *data) {
  ...
  data->res_x = pose.resolution_x;
  data->res_y = pose.resolution_y;
