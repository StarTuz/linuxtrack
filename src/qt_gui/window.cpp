...
void Window::newPose(linuxtrack_full_pose_t *raw, linuxtrack_pose_t *unfiltered,
...
void Window::update_pic() {
  glWidget->update(); // updateGL() is deprecated in Qt6, update() works in both
                      // Qt5/Qt6
}
